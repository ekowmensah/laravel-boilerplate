...
<div class="row mb-3">
    <div class="col-md-6">
        <h2>Create Savings Charge</h2>
    </div>
    <div class="col-md-6 text-end">
        <a href="<?php echo BASE_URL; ?>savings-charges" class="btn btn-secondary">
            <i class="cil-arrow-left"></i> Back
        </a>
    </div>
</div>

<form method="POST" action="<?php echo BASE_URL; ?>savings-charges/create">
    <div class="card">
    ...
    <div class="mt-3">
        ...
        <a href="<?php echo BASE_URL; ?>savings-charges" class="btn btn-secondary btn-lg">Cancel</a>
    </div>
</form>
