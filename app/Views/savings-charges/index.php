...
<div class="row mb-3">
    <div class="col-md-6">
        <h2>Savings Charges</h2>
    </div>
    <div class="col-md-6 text-end">
        <a href="<?php echo BASE_URL; ?>savings-charges/create" class="btn btn-primary">
...
<div class="card">
    <div class="card-header"><strong>All Savings Charges</strong></div>
    <div class="card-body">
            ...
            <tbody>
                <?php if (!empty($charges)): ?>
                    ...
                    <tr>
                        ...
                        <td><?php echo ($charge['percentage'] ?? 0) . '%'; ?></td>
                        <td>
