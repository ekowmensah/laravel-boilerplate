...
<div class="row mb-3">
    ...
    <div class="col-md-6 text-end">
        <a href="<?php echo BASE_URL; ?>expenses" class="btn btn-secondary">
            <i class="cil-arrow-left"></i> Back
        </a>
    </div>
</div>

<form method="POST" action="<?php echo BASE_URL; ?>expenses/create">
    <div class="card">
    ...
    <div class="mt-3">
        <button type="submit" class="btn btn-primary btn-lg">
            <i class="cil-save"></i> Record Expense
        </button>
        <a href="<?php echo BASE_URL; ?>expenses" class="btn btn-secondary btn-lg">Cancel</a>
    </div>
</form>
